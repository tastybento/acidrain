 ...
 *******************************************************************************/
package com.wasteofplastic.acidrain.util;
...
public class VaultHelper {
    ...
    public static boolean setupEconomy() {
        RegisteredServiceProvider<Economy> economyProvider = AcidRain.getPlugin().getServer().getServicesManager()
    ...
    public static boolean setupPermissions() {
        RegisteredServiceProvider<Permission> permissionProvider = AcidRain.getPlugin().getServer().getServicesManager()
